...
function Header() {
  return (
    <header className="fixed top-0 left-0 w-full bg-black bg-opacity-70 shadow-md">
      <nav className="container mx-auto py-3">

        <div className="flex justify-between items-center">
          <div><a href="#intro" className="nav-link p-1.5 border-2 border-white text-white  font-bold hover:text-gray-300 transition-colors duration-300 ease-in-out">
            Jaider Nunes
          </a></div>
